defmodule ColtWeb.TermsLive do
  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash} current_user={@current_user} landing={true}>
      <Legal.page kicker="Liid · legal" title="Terms of Service" updated="8 June 2026">
        <Legal.section title="Agreement">
          <p>
        ...
        <Legal.section n="1" title="The service">
          <p>
        ...
        <Legal.section n="2" title="Accounts">
          <p>
        ...
        <Legal.section n="3" title="Connected mailboxes">
          <p>
        ...
        <Legal.section n="4" title="Acceptable use">
        ...
        <Legal.section n="5" title="Your data &amp; privacy">
          <p>
        ...
        <Legal.section n="6" title="AI-generated content">
          <p>
        ...
        <Legal.section n="8" title="Intellectual property">
          <p>
        ...
        <Legal.section n="9" title="Disclaimers">
          <p>
        ...
        <Legal.section n="10" title="Limitation of liability">
          <p>
        ...
        <Legal.section n="11" title="Indemnity">
          <p>
        ...
        <Legal.section n="12" title="Suspension &amp; termination">
          <p>
        ...
        <Legal.section n="13" title="Governing law">
          <p>
        ...
        <Legal.section n="14" title="Changes">
          <p>
        ...
        <Legal.section n="15" title="Contact">
          <p>
