defmodule ColtWeb.Router do
  ...
  scope "/", ColtWeb do
    ...
    ash_authentication_live_session :authenticated_routes,
      ...
      live "/campaigns/:id/sales/checklist", Sales.ChecklistLive
      live "/campaigns/:id/sales", Sales.SalesFunnelLive
      live "/campaigns/:id/sales/:bucket", Sales.SalesFunnelLive
      live "/campaigns/:id/sales/:bucket/:contact_id", Sales.SalesFunnelLive
      ...
      live "/admin/industries", Admin.IndustriesLive
      live "/admin/storage", Admin.StorageLive
      live "/admin/costs", Admin.CostsLive
      live "/admin/contact-costs", Admin.ContactCostsLive
      live "/admin/clients", Admin.ClientsLive
      live "/admin/clients/:id", Admin.ClientLive
